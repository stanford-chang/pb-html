...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MainSection = __webpack_require__(162);
	  ...
	  _createClass(App, [{
	    ...
	    value: function chat(input) {
	      ...
	      _jquery2.default.ajax({
	        ...
	        success: function success(data) {
	          ...
	          var newState = {
	            messages: _this2.state.messages.concat({ bot: true, text: data.text })
	          };
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_MainSection2.default, { messages: this.state.messages }),
	        _react2.default.createElement(_Footer2.default, { chat: this.chat.bind(this) })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChatItem = __webpack_require__(163);
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      props.messages.map(function (message, i) {
	        return _react2.default.createElement(_ChatItem2.default, { message: message, key: i });
	      })
	    )
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChatForm = __webpack_require__(165);
	...
	var Footer = function Footer(props) {
	  return _react2.default.createElement(
	    'footer',
	    null,
	    _react2.default.createElement(_ChatForm2.default, { chat: props.chat })
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatForm = function (_React$Component) {
	  ...
	  function ChatForm(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ChatForm).call(this, props));
	  ...
	  _createClass(ChatForm, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'form',
	        null,
	        _react2.default.createElement('input', { ref: 'input', placeholder: 'Say something' }),
	        _react2.default.createElement(
	          'button',
